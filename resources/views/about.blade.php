...
<div class="container py-5">
    <div class="row h-100 align-items-center py-5">
        <div class="col-lg-6">
            ...
            <p class="lead text-muted mb-0">Welcome to E-commerce, your number one source for all products.
                We're dedicated to giving you the very best of products, with a focus on new products,
                good products, cheap products.
    ...
    <div class="container py-5">
        <div class="row align-items-center mb-5">
            <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
                ...
                <p class="font-italic text-muted mb-4">Founded in 2022 by Abdurrahman, E-commerce has come a long way
                    from its beginnings in Istanbul. When Abdurrahman first started out, his passion for
                    eco-friendly cleaning products drove them to start this business so
                    that E-commerce can offer you the world's most advanced
                    e-commerce. We now serve customers all over the world, and are thrilled that
